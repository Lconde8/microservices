package com.costumer.costumer.Controller;

import com.costumer.costumer.Entity.Customer;
import com.costumer.costumer.Entity.Region;
import com.costumer.costumer.Service.CustomerService;
...
public class CustomerRest {
    ...
    public ResponseEntity<Customer> createCustomer(@Valid @RequestBody Customer customer, BindingResult result){
        ...
        if(result.hasErrors()) throw new ResponseStatusException(HttpStatus.BAD_REQUEST, this.formatMessage(result));
